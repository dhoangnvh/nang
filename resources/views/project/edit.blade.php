...
<div class="container-fluid pt-3">
    <div class="card">
        <form role="form" method="POST" action="{{ route('project.update', ['id'=>$project->id]) }}" enctype="multipart/form-data">
          @csrf
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <textarea name="content" id="content" rows="10" class="form-control textarea">{!!$project->content!!}</textarea>
              </div>
            </div>
            <!-- /.card-body -->
